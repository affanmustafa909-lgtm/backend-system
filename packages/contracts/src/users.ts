...
export const POPS_MODULE_ACCESS: { id: string; label: string; description: string }[] = [
  ...
  { id: "finance.view", label: "Finance view", description: "View Dist finance dashboard, ledgers, and reports" },
  { id: "finance.create", label: "Finance create", description: "Create draft journals, expenses, and cash/bank drafts" },
  { id: "finance.edit", label: "Finance edit", description: "Edit unposted finance documents" },
  { id: "finance.post", label: "Finance post", description: "Post journals and financial documents" },
  { id: "finance.reverse", label: "Finance reverse", description: "Reverse posted journals (creates a reversing entry)" },
  { id: "finance.approve", label: "Finance approve", description: "Approve expenses and financial documents" },
  { id: "finance.close_period", label: "Finance close period", description: "Close an accounting period" },
  { id: "finance.reopen_period", label: "Finance reopen period", description: "Reopen a closed period (audited)" },
  { id: "finance.reconcile", label: "Finance reconcile", description: "Bank match and ledger reconciliation checks" },
  { id: "finance.view_sensitive", label: "Finance sensitive", description: "View unmasked bank account numbers" },
  ...
  { id: "field.view", label: "Field force view", description: "View field-force dashboard, salesmen, PJP, visits, and performance" },
  { id: "field.manage", label: "Field force manage", description: "Assign salesmen, territories, routes, and customers" },
  { id: "field.pjp", label: "Field PJP", description: "Create, version, and generate permanent journey plans" },
  { id: "field.visit", label: "Field visits", description: "Start, complete, miss, and reschedule own or assigned visits" },
  { id: "field.target", label: "Field targets", description: "Create and revise salesman/territory/route targets" },
