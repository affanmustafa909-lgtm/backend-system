...
export const createMedicineSchema = z.object({
  ...
  companyProductCode: z.string().optional(),
  saleOnTradePrice: z.boolean().optional(),
  schemeDisc1Pct: z.number().min(0).max(100).optional(),
  schemeDisc2Pct: z.number().min(0).max(100).optional(),
  schemeQty: z.number().min(0).optional(),
  schemeBonusQty: z.number().min(0).optional(),
  discOnRetailPct: z.number().min(0).max(100).optional(),
  extraTaxPct: z.number().min(0).max(100).optional(),
  salesTaxType: z.string().optional(),
  extSalesTaxType: z.string().optional(),
  fbrProductType: z.string().optional(),
  advTaxEnabled: z.boolean().optional(),
  sortOrder: z.number().int().optional(),
  locked: z.boolean().optional(),
  holdQty: z.number().min(0).optional(),
  status: z.string().optional(),
...
export const createPharmacyCompanySchema = z.object({
  ...
  salesmanCommissionPct: z.number().min(0).max(100).optional(),
  showForAdvTax: z.string().optional(),
  productPolicyJson: z.string().optional(),
  discountPolicyJson: z.string().optional(),
  companyShiftingJson: z.string().optional(),
  status: z.string().optional(),
});
...
export const createPharmacyTradeCustomerSchema = z.object({
  ...
  monthlySalesTargetPkr: z.number().min(0).optional(),
  modeOfPayment: z.string().optional(),
  timing: z.string().optional(),
  visitFrequency: z.number().min(0).optional(),
  visitingDays: z.array(z.string()).optional(),
  termsOfPayment: z.string().optional(),
  license9No: z.string().optional(),
  license9Expiry: z.string().optional(),
  license10No: z.string().optional(),
  license10Expiry: z.string().optional(),
  license11No: z.string().optional(),
  license11Expiry: z.string().optional(),
  advTaxType: z.string().optional(),
  isFocCustomer: z.boolean().optional(),
  canDeductTax: z.boolean().optional(),
  taxPct: z.number().min(0).max(100).optional(),
  imageUrl: z.string().optional(),
  discountPolicyJson: z.string().optional(),
  bonusPolicyJson: z.string().optional(),
  companyCreditLimitsJson: z.string().optional(),
  companyIdsJson: z.string().optional(),
  blockSalesJson: z.string().optional(),
  othersJson: z.string().optional(),
  ...
  partyMode: z.string().optional(),
  stxNo: z.string().optional(),
  sector: z.string().optional(),
  licenceNo: z.string().optional(),
  licenceExpiry: z.string().optional(),
  activeTaxPayer: z.boolean().optional(),
  incomeTaxExempt: z.boolean().optional(),
