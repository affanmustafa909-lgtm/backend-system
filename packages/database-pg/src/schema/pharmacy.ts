...
export const pharmacyMedicines = pgTable("pharmacy_medicines", {
  ...
  /** Legacy Dist product-master fields (desktop Product form parity). */
  companyProductCode: text("company_product_code"),
  saleOnTradePrice: boolean("sale_on_trade_price").notNull().default(false),
  schemeDisc1Pct: integer("scheme_disc1_pct").notNull().default(0),
  schemeDisc2Pct: integer("scheme_disc2_pct").notNull().default(0),
  schemeQty: integer("scheme_qty").notNull().default(0),
  schemeBonusQty: integer("scheme_bonus_qty").notNull().default(0),
  discOnRetailPct: integer("disc_on_retail_pct").notNull().default(0),
  extraTaxPct: integer("extra_tax_pct").notNull().default(0),
  salesTaxType: text("sales_tax_type"),
  extSalesTaxType: text("ext_sales_tax_type"),
  fbrProductType: text("fbr_product_type"),
  advTaxEnabled: boolean("adv_tax_enabled").notNull().default(false),
  sortOrder: integer("sort_order").notNull().default(0),
  locked: boolean("locked").notNull().default(false),
  holdQty: integer("hold_qty").notNull().default(0),
